    ...
    <div class="thumblist">
        <div class="list-thumbs " data-sizes="100vw" id=" thumbs">
            @foreach ($tour->panos as $key=>$pano)
                <div class="item-thumbs @if($key == 0) active @endif {{ $pano->id_thumb }}" id="{{ $pano->id_thumb }}">
            ...
            <div class="menu_bottom">
                ...
                <div class="menu_icon">
                    <div class="map">
                        <div class="container">
                            <div class="map_tour">
                                <iframe src="tour360/{{ $tour->code }}/map" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen frameborder="0"></iframe>
