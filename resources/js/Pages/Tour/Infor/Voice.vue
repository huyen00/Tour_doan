<template>
  <section class="content">
    ...
    <ModalVoice :errors="errors" :infor="infor"  :tour="tour" :category_voices="category_voices" :google_voices="google_voices"/>
    <button
      type="button"
...
layout: Layout,
  ...
  data() {
    ...
    deleteRow(id) {
      ...
      this.$inertia.delete(route("tour.infor.voice.delete", id));
    },
    onAdd() {
      Bus.$emit("onAddVoice");
    },
