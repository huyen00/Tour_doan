<template>
    <div class="modal-content fm-modal-about">
        <div class="modal-header">
            <h5 class="modal-title">Select Scene</h5>
        ...
        <div class="modal-body">
            <form @submit.prevent="save">
                ...
                <div class="form-group" :class="errors.linkedscene ? 'is-valid' :''">
                    <label for="recipient-name" class="col-form-label">linkedscene:</label>
                    <select
                      id="countries"
                      v-model="form.linkedscene"
                      :class="errors.linkedscene ? 'border-red-500' :''"
                      class="bg-gray-50 border border-gray-300 text-gray-900 text-xl rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    >
                      <option
                    ...
                    <div
                      class="text-red-500"
                      v-if="errors.linkedscene"
                    >{{ errors.linkedscene }}</div>
                </div>
      ...
      data(){
        return {
            form:this.$inertia.form({
              action:"onclick",
              linkedscene:this.hotspot.linkedscene ? this.hotspot.linkedscene : this.panos[0].id_thumb ,
              type:"linkedscene"
        })
        }
      },
