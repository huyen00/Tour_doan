                                ...
                                <div class="row ">
                                    ...
                                    <div class="text_news">
                                        ...
                                        <div class="box_duoi">
                                            ...
                                            <a href="<?php echo e(route('post.detail',__($content->sub_title))); ?>" class="read_view">Xem thêm <i class="fa-regular fa-calendar-days"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </li>  
...
<?php echo $__env->make('landingpage.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Tour_doan\resources\views\landingpage\post_detail.blade.php ENDPATH**/ ?>